...
if (!defined('CONTACT_EMAIL')) {
    ...
    define('NINJA_WEB_URL', env('NINJA_WEB_URL', 'https://www.yacsocial.com'));
    define('NINJA_APP_URL', env('NINJA_APP_URL', 'https://app.yacsocial.com'));
    define('NINJA_DOCS_URL', env('NINJA_DOCS_URL', 'http://docs.yacsocial.com/en/latest'));
    define('NINJA_DATE', '2000-01-01');
    define('NINJA_VERSION', '2.9.1' . env('NINJA_VERSION_SUFFIX'));

    define('SOCIAL_LINK_FACEBOOK', env('SOCIAL_LINK_FACEBOOK', 'https://www.facebook.com/yacsocial'));
    define('SOCIAL_LINK_TWITTER', env('SOCIAL_LINK_TWITTER', 'https://twitter.com/yacsocial'));
    define('SOCIAL_LINK_GITHUB', env('SOCIAL_LINK_GITHUB', 'https://github.com/yacsocial/billing/'));

    define('NINJA_FORUM_URL', env('NINJA_FORUM_URL', 'https://support.yacsocial.com/'));
    define('NINJA_CONTACT_URL', env('NINJA_CONTACT_URL', 'https://www.yacsocial.com/contact/'));
    define('NINJA_FROM_EMAIL', env('NINJA_FROM_EMAIL', 'billing@yacsocial.com'));
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.yacsocial.com/referral-program/'));
    ...
    define('TEST_USEREMAIL', 'admin@admin.com');
