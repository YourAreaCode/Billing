...
class AccountRepository
{
    ...
    public function getNinjaAccount()
    {
        ...
        if ($account) {
            ...
            $account = new Account();
            $account->name = 'YAC Billing';
            $account->work_email = 'billing@yacsocial.com';
            $account->work_phone = '+1 (888) 244-7751';
            ...
            $user->confirmed = true;
            $user->email = 'billing@yacsocial.com';
            $user->password = $random;
            $user->username = $random;
            $user->first_name = 'YAC';
            $user->last_name = 'Billing';
