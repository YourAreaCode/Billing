...
{!! link_to('https://www.yacsocial.com/?utm_source=powered_by', 'InvoiceNinja.com', ['target' => '_blank', 'title' => trans('texts.created_by', ['name' => 'Hillel Coren'])]) !!} -
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="panel-body">
          ...
          <p>{!! trans('texts.reseller_text', ['email' => HTML::mailto('billing@yacsocial.com')]) !!}</p>
        </div>
