...
@section('head')
    ...
    @endforeach
	<script src="{{ asset('/js/pdf.built.js') }}?no_cache={{ NINJA_VERSION }}" type="text/javascript"></script>
                ...
                <div data-bind='template: { foreach: contacts,
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-offset-4">
                            ...
                            <span data-bind="visible: $index() === ($parent.contacts().length - 1)" class="pull-right purplelink bold">
