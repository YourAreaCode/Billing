        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div style="overflow:hidden">
                    ...
                    <div class="revenue-div in-bold pull-right" style="color:#92298E">
                    </div>
                    <div class="in-bold">
                        @if (count($paidToDate))
            ...
            <div class="panel-body">
                <div style="overflow:hidden">
                    @if (count($expenses))
                        ...
                        <div class="expenses-div in-bold pull-right" style="color:#92298E">
                        </div>
                        <div class="in-bold">
                    ...
                    @else
                        ...
                        <div class="average-div in-bold pull-right" style="color:#92298E">
                        </div>
                        <div class="in-bold">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div style="overflow:hidden">
                    ...
                    <div class="outstanding-div in-bold pull-right" style="color:#92298E">
                    </div>
                    <div class="in-bold">
                        @if (count($balances))
                ...
                <h3 class="panel-title">
                    @if (count($expenses) && count($averageInvoice))
                        <div class="pull-right" style="font-size:14px;padding-top:4px;font-weight:bold">
                            ...
                            @endforeach
                            <span class="average-div" style="color:#92298E"/>
                        </div>
                    @endif
