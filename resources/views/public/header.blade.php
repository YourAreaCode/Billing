        ...
        <div class="container">
            <div class="navbar-header">
                ...
                @if (!isset($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
                    ...
                    <a class="navbar-brand" href="{{ URL::to(NINJA_WEB_URL) }}" target="_blank"><img src="{{ asset('images/yacsocial-logo.png') }}" style="height:20px"></a>
                @endif
            </div>
...
<footer id="footer" role="contentinfo">
            ...
            <div id="footer-menu" class="menu-wrap">
                <ul id="menu-footer-menu" class="menu">
                    <li id="menu-item-31" class="menu-item-31">
                        {!! link_to('#', 'Facebook', ['target' => '_blank', 'onclick' => 'openUrl("https://www.facebook.com/yacsocial", "/footer/social/facebook")']) !!}
                    </li>
                    <li id="menu-item-32" class="menu-item-32">
                        {!! link_to('#', 'Twitter', ['target' => '_blank', 'onclick' => 'openUrl("https://twitter.com/yacsocial", "/footer/social/twitter")']) !!}
                    </li>
    ...
    <div class="bottom">
        <div class="wrap">
            @if (!isset($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
                <div class="copy">Copyright &copy;{{ date('Y') }} <a href="{{ NINJA_WEB_URL }}" target="_blank">YAC Billing</a>. All rights reserved.</div>
            @endif
        </div><!-- .wrap -->
    </div><!-- .bottom -->
</footer><!-- #footer -->
...
<!--<div class="fb-follow" data-href="https://www.facebook.com/yacsocial" data-colorscheme="light" data-layout="button" data-show-faces="false"></div>-->

      <!--<a href="https://twitter.com/yacsocial" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @yacsocial</a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>-->
      <!--<div class="fb-like" data-href="https://www.yacsocial.com" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div>          -->
      <!--
      <div class="fb-share-button" data-href="https://www.yacsocial.com/" data-type="button"></div>
      &nbsp;

      <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://www.yacsocial.com/" data-via="yacsocial" data-related="hillelcoren" data-count="none" data-text="Free online invoicing">Tweet</a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
      &nbsp;
      <div class="g-plusone" data-size="medium" data-width="300" data-href="https://www.yacsocial.com/" data-annotation="none" data-count="false" data-recommendations="false"></div>
  ...
  -->
      ...
      <script type="IN/Share" data-url="https://www.yacsocial.com/"></script>
  -->
