...
<head>
    ...
    @else
        <title>{{ isset($title) ? ($title . ' | YAC Billing') : ('YAC Billing | ' . trans('texts.app_title')) }}</title>
...
<!-- Version: {{ NINJA_VERSION }} -->
    ...
    <meta charset="utf-8">
    <meta property="og:site_name" content="YAC Billing"/>
    <meta property="og:url" content="{{ SITE_URL }}"/>
    <meta property="og:title" content="YAC Billing"/>
    ...
    <meta name="apple-mobile-web-app-title" content="YAC Billing">
    <meta name="application-name" content="YAC Billing">
