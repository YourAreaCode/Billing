...
$LANG = array(
    ...
    'confirmation_subject' => 'Validation du compte YAC Billing',
    ...
    'email_from' => 'L\'équipe YAC Billing',
    ...
    'agree_to_terms' => 'J\'accepte les conditions d\'utilisation d\'YAC Billing :terms',
    ...
    'pro_plan_feature4' => 'Suppression de "Créer par YAC Billing"',
    ...
    'customize_help' => '<p>Nous utilisons <a href="http://pdfmake.org/" target="_blank">pdfmake</a> pour définir la présentation graphique des factures de manière déclarative. Pdfmake <a href="http://pdfmake.org/playground.html" target="_blank">playground</a> fournit une excellente façon de voir la librairie en action.</p>
                        ...
                        <p>Si vous avez besoin d\'aide à ce sujet, vous pouvez publier une question sur notre <a href="https://www.yacsocial.com/forums/forum/support/" target="_blank">forum d\'aide</a> avec la présentation graphique que vous utilisez.</p>',
    ...
    'white_label_text' => 'Achetez une licence sans pub d\'UN AN au coût de $:price pour retirer la marque de YAC Billing des factures et du portail client.',
    ...
    'pro_plan_remove_logo' => ':link pour supprimer le logo YAC Billing en souscrivant au plan pro',
    ...
    'pro_plan_year_description' => 'Abonnement à une année du plan YAC Billing Pro.',
    'pro_plan_month_description' => 'Abonnement à un mois du plan YAC Billing Pro.',
    'enterprise_plan_product' => 'Plan Enterprise',
    'enterprise_plan_year_description' => 'Abonnement à une année du plan YAC Billing Enterprise.',
    'enterprise_plan_month_description' => 'Abonnement à une année du plan YAC Billing Enterprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous souhaitez importer les données dans YAC Billing.',
    ...
    'wepay_account_description' => 'Passerelle de paiement pour YAC Billing',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci de vouloir essayer le Bot de YAC Billing.<br/>Tu dois te créer un compte gratuit à <a href="https://www.yacsocial.com">yacsocial.com</a> pour pouvoir utiliser de bot.<br/>Envoie-moi l\'adresse courriel de ton compte pour commencer.',
    ...
    'security_code_email_subject' => 'Code de sécurité pour le Bot de YAC Billing',
    'security_code_email_line1' => 'Ceci est votre code de sécurité pour le Bot de YAC Billing.',
    ...
    'update_invoiceninja_title' => 'Mettre à jour YAC Billing',
    'update_invoiceninja_warning' => 'YAC Billing crée une sauvegarde de votre base de données et de vos fichiers avant la mise à jour.',
    'update_invoiceninja_available' => 'Une nouvelle version de YAC Billing est disponible.',
    'update_invoiceninja_unavailable' => 'Aucune mise à jour de YAC Billing disponible.',
