...
$LANG = array(
    ...
    'app_description' => 'YAC Billing is een gratis, open-source oplossing voor het maken en versturen van facturen aan klanten. Met YAC Billing, kun je gemakkelijk mooie facturen maken en verzenden vanaf elk apparaat met internettoegang. Je klanten kunnen je facturen afdrukken, downloaden als pdf bestand en je zelfs online betalen vanuit het systeem.',
    'rows' => 'rijen',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomein',
    ...
    'pro_plan_feature4' => 'Verwijder "Aangemaakt door YAC Billing"',
...
<p>Als je ergens hulp bij nodig hebt, stel dan een vraag op ons <a href="https://www.yacsocial.com/forums/forum/support/" target="_blank">support forum</a>.</p>',
    ...
    'white_label_text' => 'Koop een white label licentie voor één jaar voor $:price om de YAC Billing reclame te verwijderen van facturen en het klantenportaal.',
    ...
    'pro_plan_year_description' => 'Jaarabonnement op YAC Billing Pro.',
    'pro_plan_month_description' => 'Maandabonnement op YAC Billing Pro.',
    'enterprise_plan_product' => 'Zakelijk abonnement',
    'enterprise_plan_year_description' => 'Jaarabonnement op YAC Billing zakelijk.',
    'enterprise_plan_month_description' => 'Maandabonnement op YAC Billing zakelijk.',
...
Kom terug naar deze betalingsmethode pagina zodra u de bedragen heeft ontvangen en klik op "Verificatie voltooien" direct naast de rekening.',
    ...
    'export_help' => 'Gebruik JSON als u van plan bent de data in YAC Billing te importeren.',
...
',
    ...
    'wepay_account_description' => 'Betalings gateway voor YAC Billing',
    ...
    'bot_get_email' => 'Hallo! (wave)<br/>bedankt om de YAC Billing Bot uit te proberen.<br/>Je moet een gratis account aanmaken op  <a href="https://www.yacsocial.com">yacsocial.com</a> om de bot te kunnen gebruiken.<br/>Stuur me uw e-mailadres om van start te gaan.',
    ...
    'security_code_email_subject' => 'Beveiligingscode voor YAC Billing Bot',
    'security_code_email_line1' => 'Dit is uw YAC Billing Bot beveiligingscode.',
    ...
    'self-update' => 'Update',
    'update_invoiceninja_title' => 'YAC Billing bijwerken',
    'update_invoiceninja_warning' => 'Maak een backup van de database en bestanden vóór het upgraden van YAC Billing!',
    'update_invoiceninja_available' => 'Een nieuwe versie van YAC Billing is beschikbaar.',
    'update_invoiceninja_unavailable' => 'Er is geen nieuwe versie van YAC Billing beschikbaar.',
