...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekräfta ditt YAC Billing konto',
    ...
    'agree_to_terms' => 'Jag godkänner YAC Billing :terms',
    ...
    'pro_plan_success' => 'Tack för att du väljer YAC Billing\'s Pro!<p/>&nbsp;<br/>
          ...
          -- maila oss på billing@yacsocial.com',
    ...
    'pro_plan_feature4' => 'Radera "Skapad av YAC Billing"',
...
<P> Om du behöver hjälp, posta en fråga på vår <a href="https://www.yacsocial.com/forums/forum/support/" target="_blank"> supportforum </a> med designen du använder. </ p>',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort YAC Billing referens från faktura och klient portal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort YAC Billing-logotypen genom att uppgradera till Pro nivå',
    ...
    'pro_plan_year_description' => 'Ett års registering på YAC Billing Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på YAC Billing Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på YAC Billing Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på YAC Billing Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använd JSON om du planerar importera data till YAC Billing',
    'JSON_file' => 'JSON Fil',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för YAC Billing',
    ...
    'bot_get_email' => 'Hej! (wave) <br/> Tack för att ni testar YAC Billing Bot. <br/> Du behöverskapa ett gratiskonto på <a href="https://www.yacsocial.com">yacsocial.com</a> för att använda denna bot. <br/> Skicka mig din e-post för att komma igång.',
    ...
    'security_code_email_subject' => 'Säkerhetskod för YAC Billing Bot.',
    'security_code_email_line1' => 'Detta är din YAC Billing Bot säkerhetskod.',
    ...
    'update_invoiceninja_title' => 'Uppdatera YAC Billing',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar YAC Billing, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av YAC Billing finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av YAC Billing finns tillgänglig.',
