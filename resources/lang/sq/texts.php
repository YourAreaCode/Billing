...
$LANG = array(
    ...
    'pro_plan_success' => 'Ju faleminderit që keni zgjedhur YAC Billing Pro plan!<p/>&nbsp;<br/>
                          ...
                          -- na dërgoni email në billing@yacsocial.com',
    ...
    'app_description' => 'YAC Billing është zgjidhje falas, open-cource për faturim të konsumatorëve. Me Invoice Ninjca, ju lehtësisht mund të krijoni dhe dërgoni fatura të bukura nga cilado pajisje e cila ka qasje në internet. Klientët tuaj mund të printojnë faturat, t\'i shkarkojnë si PDF fajlla apo edhe ti paguajn online brenda sistemit.',
    'rows' => 'rreshta',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Largoni "Krijuar nga YAC Billing"',
    ...
    'customize_help' => '<p>Ne përdorim <a href="http://pdfmake.org/" target="_blank">pdfmake</a> për të krijuar faturat PDF dhe dizajnin e tyre. pdfmake <a href="http://pdfmake.org/playground.html" target="_blank">playground</a> ofron mundësi të mirë për të parë librarinë në veprim. </p>
                        ...
                        <p>Nëse ju duhet ndihmë për të qartësuar diçka ose për të bërë ndonjë pytje mund të na shkruani në <a href="https://www.yacsocial.com/forums/forum/support/" target="_blank">forumin tonë</a> me dizajnin që jeni duke përdorur.</p>',
    ...
    'white_label_text' => 'Bli nje license vjecare me cmimin $:price per te hequr logot dhe tekstet e YAC Billing nga fatura dhe portali i klientit. ',
    ...
    'pro_plan_remove_logo' => ':link për të larguar YAC Billing logo duke iu bashkangjitur Pro Planit',
...
Fushat e njësive në faturë',
    ...
    'pro_plan_year_description' => 'Regjistrimi një vjeçar në YAC Billing Pro Plan.',
    'pro_plan_month_description' => 'Regjistrim një mujor në YAC Billing Pro Plan.',
    'enterprise_plan_product' => 'Plani Enterprise',
    'enterprise_plan_year_description' => 'Regjistrimi një vjeçar në YAC Billing Enterprise Plan.',
    'enterprise_plan_month_description' => 'Regjistrimi një mujor në YAC Billing Enterprise Plan.',
...
Pasi të keni pranuar shumat, kthehuni në faqen e metodave të pagesës dhe klikoni "Përfundo Verifikimin" afër llogarisë.',
    ...
    'export_help' => 'Përdorni JSON nëse planifikoni të importoni të dhëna në YAC Billing',
    ...
    'wepay_account_description' => 'Kanalet e pagesës për YAC Billing',
    ...
    'bot_get_email' => 'Pershendetje! (wave)<br/>Faleminderit qe provuat YAC Billing Bot.<br/>You duhet te krijoni nje llogari falas ne <a href="https://www.yacsocial.com">yacsocial.com</a> per te perdorur kete bot.?<br/>Me dergoni emailin e llogarise tuaj per te filluar. ',
    ...
    'security_code_email_subject' => 'Kodi i sigurise per YAC Billing Bot',
    'security_code_email_line1' => 'Ky eshte kodi juaj i sigurise per YAC Billing Bot. ',
    ...
    'update_invoiceninja_title' => 'Perditeso YAC Billing',
    'update_invoiceninja_warning' => 'Perpara se te perditesoni YAC Billing, ruani nje rezerve te skedareve dhe databazes!',
    'update_invoiceninja_available' => 'Nje version i ri i YAC Billing eshte i disponueshem. ',
    'update_invoiceninja_unavailable' => 'Nuk ka version te ri te disponueshem per YAC Billing. ',
